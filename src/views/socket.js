...
<head>
    ...
    < src="https://js.pusher.com/4.3/pusher.min.js"></>
    ...
    new Vue({
        ...
        methods: {
            connect() {
                ...
                this.pusher.subscribe('private-Api.User.Models.User.1aa84470-c586-11ea-a188-27ad4eb2d264').bind('Illuminate\\Notifications\\Events\\BroadcastNotificationCreated', function(data) {
                    console.log(data);
            ...
            loadChart() {
                $.getJSON('http://35.202.204.34/laravel-websockets/api/'+this.app.id+'/statistics', (data) => {
                    let chartData = [
                        {
            ...
            sendEvent() {
                $.post('http://35.202.204.34/laravel-websockets/event', {
                    key: this.app.key,
